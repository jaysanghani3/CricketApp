...
const Cric = () => {
  ...
  const [oveer, setOveer] = useState(0);
  ...
  useEffect(() => {
    ...
    let remainballs = ((data[1].team_balls % 6)+1) / 10;
  ...
  const handleRunClick = (e) => {
    ...
    let tempData = { ...data };
    if (
      bowler.bowling.balls % 6 == 0 &&
      bowler.bowling.balls != 0 &&
      strike.onStrike.batting.runs == 0
    )
    ...
    if (bowler.bowling.balls % 6 == 0 && bowler.bowling.balls != 0) {
      ...
      while (bowler === tempData[1].players[bowlerIndex]) {
        alert(
          "Please, Change the Bowler Same Bowler can't bowling in twice in a line."
        );
    ...
    if (extra.name === "Bye" || extra.name === "Leg Bye") {
      ...
      <div className="row">
        <div className="col-12 col-lg-7 col-sm-12 col-xl-8 mainLeftArea">
          <div className="mainScoreAreaIMG">
            <div className="mainScoreArea p-4">
              <div className="teamScore d-flex ">
                <div className="fs-4 fw-semibold me-3 p-2 pt-3">
              ...
              <div className="row d-flex my-4 ">
                <div className="col batsmanArea border-end">
                  ...
                  <div className="batsmanScore">
                    {strike.onStrike.batting.runs} (
                    {strike.onStrike.batting.balls})
                  </div>
                </div>
                <div className="col">
                  <div className="batsmanName">{strike.offStrike.name}</div>
                  <div className="batsmanScore">
                    {strike.offStrike.batting.runs} (
                    {strike.offStrike.batting.balls})
                  </div>
                </div>
              </div>
              ...
              <div className="row d-flex mt-3 border-top pt-3">
                ...
                <div className="col bowlerScore text-end mx-3">
                  ...
                  {bowler.bowling.balls % 6} - {bowler.bowling.maiden_over} -{" "}
          ...
          <div className="extra d-flex flex-wrap justify-content-between p-3">
            ...
            <div className="extraBtn text-white fs-5 p-2 btn btn-warning">
              Undo
            </div>
          </div>
        </div>
            ...
            {curRun.map((over, index) => {
                return over.map((r,index) => {
                    ...
                    <div className="row fs-5 p-2 text-start" key={index}>
                        <div className="col-2">{r.over}</div>
                        <div className="col-2"><div className="runPerBall">{r.run}</div></div>
